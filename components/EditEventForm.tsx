...
}> = ({ isOpen = false, toggleEventForm, eventID, editFormData }) => {
  // Frontend
        ...
        >
          ...
          <div className="flex flex-row gap-4 w-full bg-whit borde border-gray-300 rounded-2xl">
            <div className="flex flex-col gap-1 w-1/2">
              <label className="form__label" htmlFor="loginTime">
                Login Time
              </label>
              <div
                onClick={handleLoginTimeClick}
            ...
            <div className="flex flex-col gap-1 w-1/2">
              <label className="form__label" htmlFor="logoutTime">
                Logout Time
              </label>
              <div
                onClick={handleLogoutTimeClick}
                className="form__input w-full flex items-center !pl-0"
              >
                <input
                  required
          ...
          <div className={` lex gap-3 w-full mt-4 border-gray-300`}>
            ...
            <Button
              ...
              type="submit"
              form="editForm"
              className="bg-blue-500 min-w-40 grid place-items-center text-sm py-2.5 font-medium !rounded-full ml-auto"
