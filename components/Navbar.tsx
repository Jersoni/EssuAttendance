...
const Navbar = () => { // given default value for navbar title
    ...
    return (
        condition ? (
            <>
                {/* header */}
                <div className={` absolute w-full border-b border-gray-400 bg-white z-30 h-[4.5rem]`}></div>
                ...
                <div className='flex flex-row items-center absolute z-[100] p-3 pl-2'>
                    ...
                    {/* TITLE */}
                    <h1 className={`text-[#045511] font-bold z-30 translate-y-[1px] text-2xl ${bebasNeue.className}`}>{convertedPathname}</h1>
                </div>
