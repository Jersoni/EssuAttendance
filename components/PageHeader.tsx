    ...
    return (
        <div className={`w-full h-14 bg-white border-b border-gray-200 pl-1 pr-5 flex !z-[1200] ${className} `}>
            <div className="flex flex-row items-center gap-2" >
                ...
                <button  
                    type="button" 
                    className={`z-30 grid place-items-center h-12 min-w-12 rounded-full active:bg-gray-200 text-gray-900 ${buttonClassName}`}
                    onClick={() => {
                        returnPath
                ...
                {/* header title */}
                {title ? (
                    <div className={`w-56 text-md font-semibold flex flex-col text-gray-700`}> 
